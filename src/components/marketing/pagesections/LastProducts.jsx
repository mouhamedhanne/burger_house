...
export default function LastProducts() {
  return (
    <div>
      <Container>
        <div
          className="grid grid-cols-2 grid-rows-2 gap-x-9 gap-y-9
         w-full h-96 px-11 my-20 text-white uppercase"
        >
          <div className="relative bg-primary h-full row-span-2 rounded-md p-7">
            ...
            <div className="z-10 relative">
              <span className="block font-bold text-lg">KillerBurger</span>
          ...
          <div className="relative bg-primary h-full rounded-md p-7">
            ...
            <div className="z-10 relative">
              ...
              <span className=" text-2xl font-black">frais & pimenter</span>
            </div>
          </div>
        </div>
      </Container>
